...
Versione italiana di [SETUP.en.md](SETUP.en.md). La guida inglese resta allineata
...
`git pull upstream-it master`. La procedura completa per restare allineato è
nella [sezione 8](#8-aggiornamenti-dallupstream).
